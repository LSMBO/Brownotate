...
def getUniprotProteins(taxonomy, search_similar_species=False): 
    proteome_result = search_proteome(taxonomy["taxonId"])
    if search_similar_species == False or proteome_result:
        return proteome_result
